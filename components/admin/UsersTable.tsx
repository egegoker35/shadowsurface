      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left">
          <thead className="text-xs text-slate-500 uppercase bg-slate-950/60 border-b border-slate-800">
            <tr><th className="px-8 py-4 font-semibold">Email</th><th className="px-8 py-4 font-semibold">Role</th><th className="px-8 py-4 font-semibold">Plan</th><th className="px-8 py-4 font-semibold">Verified</th><th className="px-8 py-4 font-semibold">Joined</th><th className="px-8 py-4 font-semibold text-right">Upgrade</th></tr>
          </thead>
          <tbody>
            {users.map((u: any) => (
