        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-12 text-center">
          {scan.status === 'running' || scan.status === 'pending' ? (
            <>
              ...
              <h3 className="text-lg font-semibold text-slate-300">Scan In Progress</h3>
              <p className="text-slate-500 mt-1">Scanning is still running. Assets will appear here as they are discovered. This page updates automatically.</p>
            </>
          ) : (
            <>
              <div className="w-16 h-16 bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-4">
