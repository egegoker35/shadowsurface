    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center text-white">
        <div className="text-center">
          ...
          <button onClick={fetchData} className="mt-4 px-6 py-2.5 rounded-lg bg-emerald-600 text-white">Retry</button>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-sm text-slate-400">ShadowSurface Admin</p>
            </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
                  ...
                  <div className="text-3xl font-bold text-emerald-400 mt-1">${stats.totalRevenue?.toLocaleString() || 0}</div>
                </div>
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
                  <div className="text-sm text-slate-400">MRR</div>
                  <div className="text-3xl font-bold text-blue-400 mt-1">${stats.mrr?.toLocaleString() || 0}</div>
                </div>
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
                  <div className="text-sm text-slate-400">Paid Customers</div>
                  <div className="text-3xl font-bold text-pink-400 mt-1">{stats.paidCustomers || 0}</div>
                </div>
              </div>
            </div>
          )}
