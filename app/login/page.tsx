        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-8 shadow-xl">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div>
              ...
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-700 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500" />
            </div>
          ...
          <div className="mt-4 flex justify-between text-sm">
            <Link href="/forgot-password" className="text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400">Forgot password?</Link>
