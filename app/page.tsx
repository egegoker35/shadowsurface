    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 border-t border-slate-800">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Trusted by Security Teams</h2>
          <p className="text-slate-400 mb-8">ShadowSurface helps organizations reduce their mean-time-to-discovery from weeks to minutes.</p>
          <div className="grid sm:grid-cols-3 gap-6 text-left">
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              <p className="text-3xl font-bold text-emerald-400 mb-1">10x</p>
              <p className="text-sm text-slate-400">Faster asset discovery compared to manual reconnaissance.</p>
            </div>
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              <p className="text-3xl font-bold text-emerald-400 mb-1">99%</p>
              <p className="text-sm text-slate-400">Of cloud misconfigurations detected before exploitation.</p>
            </div>
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
              <p className="text-3xl font-bold text-emerald-400 mb-1">24/7</p>
              <p className="text-sm text-slate-400">Continuous monitoring with automated alerting.</p>
            </div>
          </div>
        </div>
      </section>
